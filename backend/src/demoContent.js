// Общие шаблоны демо-контента для seed.js (полный сброс для локальной разработки)
// и seedExamples.js (витринные примеры на проде, не трогающие реальных пользователей).
