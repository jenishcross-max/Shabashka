...
function buildSystem(categories) {
  return [
    ...
    '- listing_type = "order", если человек ищет исполнителя на разовую работу (в том числе стройка, шабашка); "vacancy", если работодатель зовёт на постоянную/сменную работу; иначе "other".',
